const grantL = {
    ...
    projects: [
                {
            name: "Ideal Exchange (IDX)",
            description:`Worked as a full stack developer for a startup building a platform that marries a stock market and kickstarter; allowing people to get crowd funding for their creative projects, and let the crowd get investment kickbacks from the success of the project.`,
            dates: "August 2024 - November 2024",
            institution: "Ideal Exchange (IDX)",
            collaborators: "N/A",
            hostingprofessor: "N/A",
            packages: ["Ruby on Rails", "React.js", "Typescript", "Next.js", "AWS S3"],
            livePage: "https://www.idealidx.com/",
            github: "N/A",
            isBuilt: true,
            cardImage: "./img/IDXScreenShot.png",
            details: {
                name: "TYPOLab",
        ...
        {
            name: "Shapez",
            description:`A simple fullstack project which utilizes RESTful API calls to generate objects in an HTML canvas element. 
            Site visitors can input their name, favorite color, and desired shape. The data will be saved in a MySQL database then loaded
            into the frontend through an API call.`,
            dates: "Spring 2025",
